...
circonstances, the work was conducted remotely, and no experiments could be
conducted.
...
methods present in the Eurocode~2 related to the assessement of the cracking
...
In order to cobtain accurate cracking indexes, the JCI recommends the use of
three-dimmensionnal finite element method.
...
\begin{figure}
  ...
  \caption{Cracking of concrete du to drying shrinkage \cite{aci}.}\label{aci}
\end{figure}
...
under \SI3\percent of the termal strains.
